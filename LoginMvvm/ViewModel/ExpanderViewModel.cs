...
namespace LoginMvvm.ViewModel
{
    ...
    {
        public List<ExpanderModel> Monkeys { get; private set; }
        //public List<ExpanderModel> ThreeMonkeys { get; private set; }
        ...
        public ExpanderViewModel()
        {
           ...
           // ThreeMonkeys = Monkeys.Take(3).ToList();
            ExpandCommand = new Command<ExpanderModel>(Expand);
            IsExpanded = true;
        }
       

        void Expand(ExpanderModel monkey)
        {
        ...
        {
            Monkeys = new List<ExpanderModel>();

            Monkeys.Add(new ExpanderModel

            {
                Name = "Baboon",
                Location = "Africa & Asia",
                Details = "Baboons are African and Arabian Old World monkeys belonging to the genus Papio, part of the subfamily Cercopithecinae.",
                ImageUrl = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.nationalgeographic.com%2Fanimals%2Farticle%2Fanimal-primate-drill-conservation-biology-mandrill&psig=AOvVaw1O_Yc-z7xa0aa_fvK1pFaC&ust=1631089031114000&source=images&cd=vfe&ved=2ahUKEwiLmtKjtuzyAhWHoUsFHTnWAvUQr4kDegUIARDOAQ"
            });
