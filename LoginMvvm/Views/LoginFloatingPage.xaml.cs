...
{
    public partial class LoginFloatingPage : ContentView
    {
        ...
        public static readonly BindableProperty ReturnTypeProperty = BindableProperty.Create(nameof(ReturnType), typeof(ReturnType), typeof(LoginFloatingPage), ReturnType.Default);
        public static readonly BindableProperty IsPasswordProperty = BindableProperty.Create("IsPassword", typeof(bool), typeof(LoginFloatingPage), default(bool));
        public static readonly BindableProperty KeyboardProperty = BindableProperty.Create("Keyboard", typeof(Keyboard), typeof(LoginFloatingPage), Keyboard.Default, coerceValue: (o, v) => (Keyboard)v ?? Keyboard.Default);

        static async void HandleBindingPropertyChangedDelegate(BindableObject bindable, object oldValue, object newValue)
        {
            var control = bindable as LoginFloatingPage;
